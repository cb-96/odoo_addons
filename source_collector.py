...
mandatory = [
    ...
    "sports_federation_competition_core/__manifest__.py",
    "sports_federation_scheduling/__manifest__.py",
    "sports_federation_registration/__manifest__.py",
    "sports_federation_calendar/__manifest__.py",
    "sports_federation_format/__manifest__.py",
    "sports_federation_schedule_approval/__manifest__.py",
    "sports_federation_matchday/__manifest__.py",

...
failures = []
for name, content in (("integration contracts", contracts), ("route inventory", inventory), ("public-site README", readme)):
...
if failures:
    print("Public route namespace documentation failed: " + "; ".join(failures), file=sys.stderr)
    raise SystemExit(1)

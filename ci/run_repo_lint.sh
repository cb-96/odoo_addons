...
workflow_transition_exit=0
matchday_transition_exit=0
result_transition_exit=0
...
echo "[lint] Validating privileged mutation boundaries"
python3 ci/check_privileged_mutation_boundaries.py || privileged_mutation_exit=$?

echo "[lint] Validating destructive token boundaries"
python3 ci/check_destructive_token_contract.py || destructive_token_exit=$?
...
echo "[lint] Validating workflow transition foundation"
python3 ci/check_workflow_transition_foundation.py || workflow_transition_exit=$?

echo "[lint] Validating match-day transition contracts"
python3 ci/check_matchday_transition_contract.py || matchday_transition_exit=$?

echo "[lint] Validating result transition contracts"
python3 ci/check_result_transition_contract.py || result_transition_exit=$?
...
echo "  Workflow transition exit code: $workflow_transition_exit"
echo "  Match-day transition exit code: $matchday_transition_exit"
echo "  Result transition exit code: $result_transition_exit"

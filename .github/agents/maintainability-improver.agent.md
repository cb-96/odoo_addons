...
- **Module boundary discipline**: `sports_federation_base`, `sports_federation_tournament`, `sports_federation_format`, and `sports_federation_scheduling` form the core competition stack — avoid coupling that should not cross these boundaries.

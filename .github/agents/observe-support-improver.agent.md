---
name: observe-support-improver
description: Improve the observation and support experience of this custom Odoo codebase by making it easier to monitor, troubleshoot, and maintain.
argument-hint: None
...
## Focus area: Observability and Supportability

Your primary goal is to make the system easier to support, debug, and operate when something goes wrong.

Focus specifically on:
- poor logging
- overly noisy logging
- weak traceability of important actions
- error messages that are too technical or too vague
- cron or automation failures that are hard to diagnose
- missing operational visibility
- lack of support-friendly context in failures
- places where support staff cannot quickly understand what happened

Inspect in detail:
- logging in critical workflows
- exception handling and error messages
- support-relevant metadata and traceability
- cron jobs and scheduled actions
- automation flows and their failure modes
- user-facing error/warning quality
- whether key actions leave enough evidence to debug problems later
- whether failures can be triaged quickly and safely

Implement the highest-value improvements that make the system easier to monitor, diagnose, and support without creating unnecessary noise.

Before concluding, also ask yourself:
- If this fails in production, how quickly could someone understand what happened?
- Which errors are still hard to trace or reproduce?
- Where is logging still missing useful context or producing useless noise?
- Which support pain points are still likely to waste time during incidents?
